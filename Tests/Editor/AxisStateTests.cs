...
public class AxisStateTests
{
    ...
    static IEnumerable RecenteringTestCases
    {
        get
        {
            yield return new TestCaseData(-100f, 100f, false, 10f, 0.5f, 0.5f, false, 0.1f, true, 0.01f, 0.01f).Returns(0.0f);
            yield return new TestCaseData(-100f, 100f, false, 10f, 0.5f, 0.5f, false, 0.1f, true, 0.5f, 5f).Returns(0.180375189f);

            yield return new TestCaseData(-100f, 100f, false, 10f, 0.5f, 0.5f, false, 0.1f, false, 0.01f, 0.01f).Returns(1.0f);
            yield return new TestCaseData(-100f, 100f, false, 10f, 0.5f, 0.5f, false, 0.1f, false, 0.5f, 5f).Returns(1.0f);
    ...
    public float TestRecentering(float minValue, float maxValue, bool wrap,
        ...
        bool enabled, float waitTime, float recenteringTime)
    {
        ...
        var recentering = new AxisState.Recentering(enabled, waitTime, recenteringTime);
