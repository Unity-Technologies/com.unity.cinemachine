...
namespace Cinemachine
{
    ...
    [SaveDuringPlay]
    public class CinemachineTriggerActivator : MonoBehaviour
    {
        ...
        public struct ActionSettings
        {
            ...
            public enum Mode
            {
                /// <summary>Just broadcast the action on to the target</summary> 
                Broadcast,    
            ...
            /// <summary>If Broadcast, this method will be called on the behaviours of the target object</summary>
            [Tooltip("If Broadcast, this method will be called on the behaviours of the target object")]
            ...
            public void Invoke()
            {
                ...
                if (currentTarget != null)
                {
                    ...
                    {
                        case Mode.Broadcast:
                            if (targetGameObject != null && m_MethodName.Length != 0)
                                targetGameObject.BroadcastMessage(m_MethodName);
                            break;
        ...
        public ActionSettings m_EnterAction = new ActionSettings(ActionSettings.Mode.Broadcast);

        /// <summary>What action to take when an eligible object exits the collider or trigger zone</summary>
        public ActionSettings m_ExitAction = new ActionSettings(ActionSettings.Mode.Broadcast);
