...
public class CinemachinePostProcessing : CinemachineExtension
{
    ...
    class CinemachinePostProcessingEditorInitialize
    {
        static CinemachinePostProcessingEditorInitialize() { CinemachinePostProcessingInitializeModule(); }
    }
#endif
    [RuntimeInitializeOnLoadMethod]
    static void CinemachinePostProcessingInitializeModule()
    {
