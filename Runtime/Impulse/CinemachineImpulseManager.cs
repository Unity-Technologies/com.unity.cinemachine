...
namespace Cinemachine
{
    ...
    public class CinemachineImpulseManager
    {
        ...
        public class ImpulseEvent
        {
            ...
            public Vector3 GetDecayedSignal(Vector3 listenerPosition)
            {
        ...
        /// <returns>The combined impulse signal offset resulting from all signals active on the specified channels</returns>
        public Vector3 GetImpulseAt(Vector3 listenerLocation, int channelMask)
        {
            ...
            if (m_ActiveEvents != null)
            {
                for (int i = m_ActiveEvents.Count - 1; i >= 0; --i)
                {
                    ...
                    if (e == null || e.Expired)
                    {
                        ...
                        signal += e.GetDecayedSignal(listenerLocation);
                }
            }
            return signal;
        }
