...
This Cinemachine [extension](CinemachineVirtualCameraExtensions) adjusts the FOV of the lens to keep the target object at a constant size on the screen, regardless of camera and target position.
