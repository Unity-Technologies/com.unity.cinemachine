...
Use the Cinemachine Recomposer [extension](CinemachineVirtualCameraExtensions.md) is an add-on module for CmCamera that adds a final tweak to the camera composition.  It is intended for use in a Timeline context, where you want to hand-adjust the output of procedural or recorded camera aiming.
...
| **Property:** | **Function:** |
|:---|:---|
| __Apply After__ | The Volume Settings profile to activate when this CmCamera is live. |
...
|  _Finalize_ | Default setting.  Applied after all standard CmCamera processing has occurred |
