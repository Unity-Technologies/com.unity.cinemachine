...
Use the Cinemachine Recomposer [extension](ProceduralMotion.md#extensions) is an add-on module for CinemachineCamera that adds a final tweak to the camera composition.  It is intended for use in a Timeline context, where you want to hand-adjust the output of procedural or recorded camera aiming.
