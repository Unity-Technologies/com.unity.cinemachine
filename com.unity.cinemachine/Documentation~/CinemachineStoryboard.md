...
Use the Cinemachine Storyboard [extension](ProceduralMotion.md#extensions) to let artists, producers, and directors contribute to your game development. Cinemachine Storyboard places a still image in screen space over the output of the Unity camera.
