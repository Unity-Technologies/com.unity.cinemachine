...
- SplineDolly and SplineCart API has changed so that position on spline is preserved when units change.  Old scenes will not deserialize correctly and their spline references and positions and units will have to be updated manually.
