...
namespace Cinemachine.Editor
{
    ...
    {
        static CinemachineSettings.BoolItem SettingsFoldedOut = new("CNMCN_Core_Folded", true);
        ...
        public static readonly GUIContent s_StoryboardGlobalMuteLabel = new GUIContent(
            "Storyboard Global Mute", 
            "If checked, all storyboards are globally muted.");
        public static readonly GUIContent s_ShowInGameGuidesLabel = new GUIContent(
            "Game View Guides", 
            "Enable the display of overlays in the Game View.  You can adjust colours and opacity in Cinemachine Preferences.");
        public static readonly GUIContent s_SaveDuringPlayLabel = new GUIContent(
            "Save During Play",
        ...
        static readonly GUIContent s_CoreActiveGizmosColour = new GUIContent(
            "Active Virtual Camera", "The colour for the active virtual camera's gizmos");
        static readonly GUIContent s_CoreInactiveGizmosColour = new GUIContent(
            "Inactive Virtual Camera", "The colour for all inactive virtual camera gizmos");
        static readonly GUIContent s_CoreBoundaryObjectGizmosColour = new GUIContent(
            "Boundary Object", "The colour to indicate secondary objects like group boundaries and confiner shapes");
        static readonly GUIContent s_DraggableGuidesLabel = new GUIContent(
        ...
        static readonly GUIContent s_ShowBrainIconsLabel = new GUIContent(
        ...
        public static void DrawCoreSettings()
        {
            ...
            EditorGUIUtility.labelWidth = GUI.skin.label.CalcSize(s_DraggableGuidesLabel).x;
            {
                EditorGUI.BeginChangeCheck();

                ShowInGameGuides.Value = EditorGUILayout.Toggle(s_ShowInGameGuidesLabel, ShowInGameGuides.Value);
                DraggableComposerGuides.Value = EditorGUILayout.Toggle(s_DraggableGuidesLabel, DraggableComposerGuides.Value);
                ShowBrainIconInHierarchy.Value = EditorGUILayout.Toggle(s_ShowBrainIconsLabel, ShowBrainIconInHierarchy.Value);
            ...
            SettingsFoldedOut.Value = EditorGUILayout.Foldout(SettingsFoldedOut.Value, "Core Settings", true);
            if (SettingsFoldedOut.Value)
            {
                ...
                ActiveGizmoColour.Value = EditorGUILayout.ColorField(s_CoreActiveGizmosColour, ActiveGizmoColour.Value);
                if (GUILayout.Button("Reset"))
                    ActiveGizmoColour.Reset();
                EditorGUILayout.EndHorizontal();

                EditorGUILayout.BeginHorizontal();
                InactiveGizmoColour.Value = EditorGUILayout.ColorField(s_CoreInactiveGizmosColour, InactiveGizmoColour.Value);
                if (GUILayout.Button("Reset"))
                ...
                EditorGUILayout.BeginHorizontal();
                EditorGUI.BeginChangeCheck();
                BoundaryObjectGizmoColour.Value = EditorGUILayout.ColorField(s_CoreBoundaryObjectGizmosColour, BoundaryObjectGizmoColour.Value);
                if (GUILayout.Button("Reset"))
