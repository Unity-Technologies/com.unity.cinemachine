...
- Automatically add CinemachineInputProvider when creating Freelook Camera through Create (Create->Cinemachine->FreeLook Camera), if com.unity.inputsystem package is present.
