...
{
    /// <summary>
    /// This is a copy of ExampleHelpWindow. The reason for the name change
    /// so that it does not conflict with ExampleHelpWindow from the other example pack.
    /// </summary>
    [AddComponentMenu("")] // Don't display in add component menu
    public class ExampleHelpWindow2 : MonoBehaviour
    {
